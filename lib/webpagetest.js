...
function getTestStatus(options, callback) {
  var id = helper.getTestId(options);

  return api.call(this, paths.testStatus, callback, {test: id}, options);
}

function getTestResults(options, callback) {
  var id = helper.getTestId(options);
...
function getPageSpeedData(options, callback) {
  var id = helper.getTestId(options);
...
function getHARData(options, callback) {
  var id = helper.getTestId(options);

  return api.call(this, paths.har, callback, {test: id}, options);
}

function getUtilizationData(options, callback) {
  var id = helper.getTestId(options);
...
function getRequestData(options, callback) {
  var id = helper.getTestId(options);
...
function getTimelineData(options, callback) {
  var id = helper.getTestId(options);
...
function getNetLogData(options, callback) {
  var id = helper.getTestId(options);
...
function getWaterfallImage(options, callback) {
  var id = helper.getTestId(options),
...
function getScreenshotImage(options, callback) {
  var id = helper.getTestId(options),
      pathname = paths.gzip,
